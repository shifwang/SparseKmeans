# Run third experiment parallelly 
# data is generated from mixture log normal with independent features
# mu = 3, 5
# p  = 200, 500, 1000
...
library('foreach')
library('doParallel')
ncores = 10 # Use two cores, use lscpu/nproc to check availabel cpus
